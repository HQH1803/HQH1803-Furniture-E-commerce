...
export const UserProvider = ({ children }) => {
    ...
    const updateUser = async ({ email, ho_ten, sdt }, role) => {
        try {
            const response = await fetch(`${process.env.REACT_APP_API_BASE_URL}/api/update-user`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    const updatePassword = async ({ email, currentPassword, newPassword }, role) => {
        try {
            const response = await fetch(`${process.env.REACT_APP_API_BASE_URL}/api/update-password`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
