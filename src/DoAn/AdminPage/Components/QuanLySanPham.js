...
function Products() {
  ...
  useEffect(() => {
    axios.get('http://furniture-e-commerce-wt2i.onrender.com/api/loai-phong').then(response => {      
  ...
  const fetchProducts = async () => {
    try {
      const response = await axios.get('http://furniture-e-commerce-wt2i.onrender.com/api/admin/san-pham');
  ...
  const fetchKichThuoc = async () => {
    try {
      const response = await axios.get('http://furniture-e-commerce-wt2i.onrender.com/api/kich-thuoc');
  ...
  const fetchMauSac = async () => { 
    try {
      const response = await axios.get('http://furniture-e-commerce-wt2i.onrender.com/api/mau-sac');
...
const handleEdit = async (product) => {
    ...
    setIsModalVisible(true);
    axios.get(`http://furniture-e-commerce-wt2i.onrender.com/api/getKichThuocMauSac/${product.id}`)
        .then(response => {
            const { kichThuoc, mauSac } = response.data;
          console.log("abc",response.data)
            setSelectedLoaiPhong(product.loai_phong_id || [])
            axios.get(`http://furniture-e-commerce-wt2i.onrender.com/api/getLoaiSanPham/${product.id_loaiSP}`)
  ...
  const handleDelete = async (productId) => {
    try {
      await axios.delete(`http://furniture-e-commerce-wt2i.onrender.com/api/admin/san-pham/${productId}`);
  ...
  const handleOk = async () => {
    try {
      ...
      if (isEdit) {
        ...
        await axios.put(`http://furniture-e-commerce-wt2i.onrender.com/api/admin/san-pham/${currentProduct.id}`, values);
        ...
        // Add new product
        const response = await axios.post('http://furniture-e-commerce-wt2i.onrender.com/api/admin/san-pham', values);
  ...
  useEffect(() => {
    if (selectedLoaiPhong) {
      axios.get('http://furniture-e-commerce-wt2i.onrender.com/api/danh-sach-phong').then(response => {
